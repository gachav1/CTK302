...
function draw() {
  ...
  if (mouseIsPressed) {
    ...
    fill("black");
    text('Olue was not built with great Intelligence', 50, 30);
    text('and it uses the portal technology with no specific intent. ', 50, 50);
    text('Olue just like using portals.', 50, 100);
    textSize(20);
    ...
    fill("black");
    text('Olue was created in a lab testing portal devices for teleportation.', 150, 30);
    text('One day Olue became sentient and it escaped.', 325, 50);
    textSize(20);
